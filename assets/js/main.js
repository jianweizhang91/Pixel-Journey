...
function overCreate() {
	...
	const restartButton = this.add.image(config.width / 2, config.height - 100, 'restart-button').setInteractive();

	endScoreText = this.add.text(config.width / 2 - 5, config.height / 2 - 9, score);
	scoreText.setFontSize(16);
